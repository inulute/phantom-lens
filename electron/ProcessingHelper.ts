...
export class ProcessingHelper {
  ...
  private async generateResponseWithImages(
    ...
    try {
      ...
      promptLines.push(
        ...
        ``,
        `# Solution`,
        `Provide the direct solution based on both visual and audio content. Use standard Markdown. If code is necessary, use appropriate code blocks.`,
        `REQUIRED: Always provide code in Java with detailed comments in English.`,
        `IMPORTANT: When adding code blocks, use triple backticks WITH the language specifier. Use \`\`\`java\\ncode here\\n\`\`\`.`,
        ``,
        `# Summary`,
        ...
        `Specify the time and space asymptotic complexity of the proposed algorithm in Big O notation.`,
        ``,
        `---`,
        `Remember: If audio is provided, reference it naturally in your response. Focus on the solution itself.`,
        `CODE FORMATTING: Use ONLY \`\`\` WITH the language specifier java for all code blocks.`
      );
  ...
  private async processExtraScreenshotsHelper(
    ...
    try {
      ...
      const promptLines = [
        `You are an expert assistant tasked with solving the additional problem shown in the images.`,
        ``,
        `## Previous Response Context`,
        `This is a continuation of the previous response. Please consider the context and build upon it accordingly.`,
        ``,
        `IMPORTANT REQUIREMENTS:`,
        `- Always provide code in Java`,
        `- Properly comment code with explanations in English`,
        `- Respond in English`,
        `- At the end of each solution, indicate the asymptotic complexity of the algorithm`,
        ``,
      ];
      ...
      promptLines.push(
        ...
        `Briefly summarize based on the visual and audio content. This helps establish context for analysis.`,
        ``,
        `# Analysis`,
        `If audio is provided, briefly reference what you hear and how it relates to the visual content. Keep this extremely brief and focus on your solution approach. One or two sentences maximum.`,
        ``,
        ...
        ``,
        `# Approach`,
        `Describe the approach used to solve the problem. Focus on implementation details and any specific techniques. Ensure this is brief and relevant to the visual/audio content.`,
        ``,
        `# Summary`,
        `Provide only 1-2 sentences focusing on implementation details. Mention if audio context influenced the solution. No conclusions or verbose explanations.`,
        ``,
